...
package net.mcreator.googlymod.world.biome;
...
import net.mcreator.googlymod.block.StrangeWoodBlock;
import net.mcreator.googlymod.block.StrangeStoneBlock;
import net.mcreator.googlymod.block.StrangeLeavesBlock;
...
public class GooglyBiomeBiome extends GooglymodModElements.ModElement {
	public static Biome biome;
	public GooglyBiomeBiome(GooglymodModElements instance) {
		super(instance, 30);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-4060742).setWaterColor(-9106832).setWaterFogColor(-7129201)
						.withSkyColor(-4060742).withFoliageColor(-11270576).withGrassColor(-11857079).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(StrangeDirtBlock.block.getDefaultState(),
								StrangeStoneBlock.block.getDefaultState(), StrangeStoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(StrangeWoodBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(StrangeLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("googlymod:googly_biome"));
			}
		}
	}
	@Override
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("googly_biome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("googly_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
		@Override
		protected TreeDecoratorType<?> func_230380_a_() {
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("googly_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
