...
public class RubyBlockBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(GooglymodModElements instance) {
		super(instance, 56);
	}
