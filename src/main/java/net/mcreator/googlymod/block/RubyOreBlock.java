...
public class RubyOreBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(GooglymodModElements instance) {
		super(instance, 55);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 7)).range(27).square().func_242731_b(7));
	}
}
