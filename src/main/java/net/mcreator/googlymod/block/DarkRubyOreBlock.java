...
public class DarkRubyOreBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:dark_ruby_ore")
	public static final Block block = null;
	public DarkRubyOreBlock(GooglymodModElements instance) {
		super(instance, 47);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		}, block.getDefaultState(), 3)).range(20).square().func_242731_b(4));
	}
}
