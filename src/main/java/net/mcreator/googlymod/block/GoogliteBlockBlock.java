...
public class GoogliteBlockBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:googlite_block")
	public static final Block block = null;
	public GoogliteBlockBlock(GooglymodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("googlite_block");
		}
