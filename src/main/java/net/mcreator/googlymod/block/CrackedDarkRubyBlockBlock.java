...
public class CrackedDarkRubyBlockBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:cracked_dark_ruby_block")
	public static final Block block = null;
	public CrackedDarkRubyBlockBlock(GooglymodModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1.25f, 15f).setLightLevel(s -> 0)
					.harvestLevel(4).harvestTool(ToolType.PICKAXE));
			setRegistryName("cracked_dark_ruby_block");
		}
