...
public class GoogleshBlockBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:googlesh_block")
	public static final Block block = null;
	public GoogleshBlockBlock(GooglymodModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("googlesh_block");
		}
