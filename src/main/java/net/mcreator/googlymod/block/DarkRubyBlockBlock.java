...
public class DarkRubyBlockBlock extends GooglymodModElements.ModElement {
	@ObjectHolder("googlymod:dark_ruby_block")
	public static final Block block = null;
	public DarkRubyBlockBlock(GooglymodModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_ruby_block");
		}
